    ...
    ui(new Ui::StudentManage)
{
    ...
    //设置按钮的图标
    ui->scorebtn->setIcon(QIcon(":/StudentSystem/img/bianfuxia.png"));
    ui->scorebtn->setFlat(true);
    ui->passwordbtn->setIcon(QIcon(":/StudentSystem/img/m8.png"));
    ui->passwordbtn->setFlat(true);
    ui->infobtn->setIcon(QIcon(":/StudentSystem/img/m14.png"));
    ui->infobtn->setFlat(true);
    ui->searchbtn->setIcon(QIcon(":/StudentSystem/img/m10.png"));
    ui->searchbtn->setFlat(true);
    ui->exitbtn->setIcon(QIcon(":/StudentSystem/img/m7.png"));
    ui->exitbtn->setFlat(true);
    ui->returnbtn->setIcon(QIcon(":/StudentSystem/img/m9.png"));
